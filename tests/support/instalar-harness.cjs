...
globalThis.__instalarTest = {
  ...
  buildProgressMeter,
  truncateTextMiddle,
  summarizeCommandForActivity,
  buildActivityBarFrame,
  shouldDisplayCommandOutput,
  shouldAnimateCommandActivity,
  printStepCard,
  initializeRuntimeLog,
  stripAnsi,
  terminalStringWidth,
  countRenderedTerminalRows,
  countRenderedCursorRows,
  ...
  runPotentiallyInteractiveArtisanCommand,
  runSetupCommands,
  collectAutoConfig,
  collectManualConfig,
  reviewManualConfig,
  ...
  setRunArtisanIfAvailable(value) { runArtisanIfAvailable = value; },
  ...
  setSubsection(value) { subsection = value; },
